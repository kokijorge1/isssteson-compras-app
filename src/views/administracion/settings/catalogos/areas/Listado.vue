      ...
      <v-card-text>
        ...
        <v-data-table
          ...
          <template slot="items" slot-scope="props">
            ...
            <td>{{ props.item.unidad_administrativa.nombre }}</td>
            <td>{{ props.item.nombre_responsable }}</td>
            <td>{{ props.item.puesto_responsable  }}</td>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'Unidad Administrativa', sortable: true, value: 'unidad_administrativa.nombre' },
        { text: 'Nombre Responsable', sortable: true, value: 'nombre_responsable' },
        { text: 'Puesto Responsable', sortable: true, value: 'puesto_responsable' },
        { text: '', sortable: false, value: '' },
      ],
    };
  },
  methods: {
    ...mapActions('settings/catalogos', ['borrarAreas']),
    onEditar(id) {
      this.idEditar = id;
      this.editar = true;
    },
  ...
  computed: {
    ...mapGetters({
      areas: 'settings/catalogos/areas',
    }),
    listado() {
      return this.areas;
    },
