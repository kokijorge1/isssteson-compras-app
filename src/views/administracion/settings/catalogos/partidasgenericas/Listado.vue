<template>
  <div id="contenedor-listado-partidas-genericas">
    <v-card flat>
      <v-card-text>
        <v-layout row wrap>
          <v-flex xs12 md4>
...
export default {
  ...
  methods: {
    ...mapActions('settings/catalogos', ['borrarPartidaGenerica']),
    onEditar(id) {
      this.idEditar = id;
      this.editar = true;
    },
